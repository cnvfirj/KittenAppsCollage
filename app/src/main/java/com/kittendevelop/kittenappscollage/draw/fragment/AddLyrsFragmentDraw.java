...
import com.kittendevelop.kittenappscollage.draw.addLyrs.FrameDialogAdd;
...
public abstract class AddLyrsFragmentDraw extends SuperFragmentDraw implements RepDraw.Adding {
    ...
    protected void slideTools() {
        if(!RepDraw.get().isImg()&&!isSlideTools()) Massages.SHOW_MASSAGE(getContext(),getContext().getResources().getString(R.string.condition_apply_tools));
            super.slideTools();
