...
import com.kittendevelop.kittenappscollage.collect.fragment.FragmentGallery;
import com.kittendevelop.kittenappscollage.collect.fragment.TutorialFragmentGallery;
import com.kittendevelop.kittenappscollage.draw.fragment.AddLyrsFragmentDraw;
import com.kittendevelop.kittenappscollage.draw.fragment.SavedKollagesFragmentDraw;
import com.kittendevelop.kittenappscollage.draw.fragment.TutorialFragmentDraw;
...
import com.kittendevelop.kittenappscollage.draw.saveSteps.ClearCatch;
import com.kittendevelop.kittenappscollage.draw.saveSteps.State;
import com.kittendevelop.kittenappscollage.draw.saveSteps.Steps;
...
import com.kittendevelop.kittenappscollage.mainTabs.ViewPageAdapter;
        ...
        if(saved){
            ...
            String[]split = report.split(delimiter);
                if (App.checkVersion()) {
                    ...
                    values.put(MediaStore.MediaColumns.DATA, split[SavedKollagesFragmentDraw.INDEX_PATH_IMG]);
